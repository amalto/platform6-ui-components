...
<Preview>
  <Story name="Default" height="300px" decorators={[withKnobs]}>
    {() => {
      ...
      const kLanguage = select("Language", languages, languages[0], "p6-grid");
      const kLoading = boolean("Loading", false, "p6-grid");
      const kEmpty = boolean("Empty", false, "p6-grid");
      const customContextMenu = (cells) => {
        return "Context menu exemple";
      };
      let headers = [
        { color: "blue", id: "col-1", label: "First", width: 150 },
        { id: "col-2", disabled: true, label: "Second", width: 150 },
