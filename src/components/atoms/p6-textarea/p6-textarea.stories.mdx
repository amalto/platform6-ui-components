...
<Preview>
  <Story name="Text" height="84px">
    {'<p6-textarea type="text"/></p6-textarea>'}
  </Story>
</Preview>

<Preview>
  <Story name="Read only" height="84px">
    {'<p6-textarea type="text" readonly value="Input value"/></p6-textarea>'}
  </Story>
</Preview>

<Preview>
  <Story name="Disabled" height="84px">
    {'<p6-textarea type="text" disabled value="Input value"/></p6-textarea>'}
  </Story>
</Preview>

<Preview>
  <Story name="Waiting" height="168px">
    {'<p6-textarea type="text" waiting></p6-textarea>'}
  </Story>
</Preview>
