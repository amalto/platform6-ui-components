...
import { Align, Mode, Position, Size } from "~shared/types";
...
import { ContextMenuFunction } from "./components/molecules/p6-grid/p6-grid";
import { HeaderCell, Row } from "~shared/grid";
import { CellHeaderAction, RenderCellEditComponent } from "./components/molecules/p6-grid/components/p6-grid-cell/p6-grid-cell";
...
export namespace Components {
    ...
    interface P6Grid {
         ...
         */
        "customContextMenu": ContextMenuFunction | undefined;
        /**
          * Grid headers
         */
        "headers": HeaderCell[];
    ...
    interface P6GridCell {
        ...
        /**
          * Click callback
         */
        "clickCallback": CellHeaderAction | undefined;
        /**
          * Cell text color
         */
         ...
         */
        "label": string;
        "renderCellEditComponent": | RenderCellEditComponent
    | undefined;
        /**
          * Index of the row
         */
    ...
    interface P6GridRow {
         ...
         */
        "moveContextMenu": (posX: number, posY: number) => void;
        /**
...
declare namespace LocalJSX {
    ...
    interface P6Grid {
         ...
         */
        "onP6Change"?: (event: CustomEvent<any>) => void;
        /**
          * Grid rows
         */
        "rows": Row[];
    ...
    interface P6GridCell {
         ...
         */
        "onP6AlignCenter"?: (event: CustomEvent<any>) => void;
        /**
          * Text align to the left
         */
        "onP6AlignLeft"?: (event: CustomEvent<any>) => void;
        /**
          * Text align to the right
         */
        "onP6AlignRight"?: (event: CustomEvent<any>) => void;
        /**
          * Double click callback
         */
        "onP6Edit"?: (event: CustomEvent<any>) => void;
        /**
          * Hide column
         */
        "onP6Hide"?: (event: CustomEvent<any>) => void;
        /**
          * Reduce column width
         */
        "onP6Minus"?: (event: CustomEvent<any>) => void;
        /**
          * Move the column to the left
         */
        "onP6MoveLeft"?: (event: CustomEvent<any>) => void;
        /**
          * Move the column to the right
         */
        "onP6MoveRight"?: (event: CustomEvent<any>) => void;
        /**
          * Raise column width
         */
        "onP6Plus"?: (event: CustomEvent<any>) => void;
        /**
          * Sort
         */
        "onP6Sort"?: (event: CustomEvent<any>) => void;
        "renderCellEditComponent"?: | RenderCellEditComponent
    | undefined;
        /**
          * Index of the row
    ...
    interface P6Language {
         ...
         */
        "onP6Change"?: (event: CustomEvent<ValidEventDetail<P6LanguageValue>>) => void;
        /**
          * Marks as read only.
         */
        "readOnly"?: boolean;
