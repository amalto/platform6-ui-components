...
declare namespace LocalJSX {
  ...
  interface P6GridActions {
     ...
     */
    onP6ResetCustomDefinitions?: (
      event: CustomEvent<ResetDefinitionsDetail>
    ) => void;
    /**
  ...
  interface P6GridHeaderMenu {
     ...
     */
    onP6ResizeColumn?: (
      event: CustomEvent<ResizeColumnDetail<DataItem>>
    ) => void;
    /**
  ...
  interface P6GridTextareaCellEditor {
     ...
     */
    onP6GridEditingCell?: (
      event: CustomEvent<EditingCellDetail<DataItem>>
    ) => void;
    /**
     * the cell row
     */
...
declare module "@stencil/core" {
  export namespace JSX {
    interface IntrinsicElements {
      ...
      "p6-grid-actions": LocalJSX.P6GridActions &
        JSXBase.HTMLAttributes<HTMLP6GridActionsElement>;
      "p6-grid-body": LocalJSX.P6GridBody &
        JSXBase.HTMLAttributes<HTMLP6GridBodyElement>;
      "p6-grid-cell": LocalJSX.P6GridCell &
        JSXBase.HTMLAttributes<HTMLP6GridCellElement>;
      "p6-grid-header": LocalJSX.P6GridHeader &
        JSXBase.HTMLAttributes<HTMLP6GridHeaderElement>;
      "p6-grid-header-cell": LocalJSX.P6GridHeaderCell &
        JSXBase.HTMLAttributes<HTMLP6GridHeaderCellElement>;
      "p6-grid-header-menu": LocalJSX.P6GridHeaderMenu &
        JSXBase.HTMLAttributes<HTMLP6GridHeaderMenuElement>;
      "p6-grid-options": LocalJSX.P6GridOptions &
        JSXBase.HTMLAttributes<HTMLP6GridOptionsElement>;
      "p6-grid-row": LocalJSX.P6GridRow &
        JSXBase.HTMLAttributes<HTMLP6GridRowElement>;
      "p6-grid-textarea-cell-editor": LocalJSX.P6GridTextareaCellEditor &
        JSXBase.HTMLAttributes<HTMLP6GridTextareaCellEditorElement>;
