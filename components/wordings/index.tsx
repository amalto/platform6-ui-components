...
export const MULTILANGUAGE_WORDINGS: Wordings = {
  ...
  tabCloseUnsave: {
    'en-US':
      'There are unsaved changes. Are you sure you want to close this tab and lose your updates?',
    'fr-FR':
      'Vous avez effectué des modifications sans les enregistrer. Êtes-vous sûr(e) de vouloir fermer cet onglet et perdre les données non sauvegardées ?',
  },
  ...
  confirmUpdateForConsistancy: {
    'en-US':
      'It seems like your items are not synchronized with the server anymore, you should save your work and update the service.',
    'fr-FR':
      'Il semble que vos éléments ne sont plus synchronisés avec le serveur, vous devriez sauvegarder votre travail et mettre à jour le service.',
  },
  ...
  successRegistrationMessage: {
    'en-US':
      'If you already set your password, you can now sign in. Otherwise, please click on the link sent to you by email to activate your account.',
    'fr-FR':
      "Si vous avez déjà créé votre mot de passe, vous pouvez vous connecter dès maintenant. Sinon, vous trouverez un lien dans l'email de confirmation qui vous pemettra d'activer votre compte.",
  },

  registrationEmailHelp: {
    'en-US': 'Make sure the email is correct to receive the confirmation link',
    'fr-FR':
      "Merci de vous assurer que votre email est correct pour pouvoir finaliser l'enregistrement",
  },
  ...
  CHEVRON_registrationIntro1: {
    'en-US':
      'This Community enables Chevron Suppliers, Chevron Internal Users and Chevron Major Capital Projects to perform electronic transactions with Chevron IT systems in a highly secure but very easy manner.',
    'fr-FR':
      'Cette communauté permet aux fournisseurs, "Internal User" et "Capital Project" Chevron de réaliser des échanges électroniques avec les systèmes informatiques de Chevron de façon simple et sécurisée.',
  },

  CHEVRON_registrationSupplierIntro: {
    'en-US':
      'To be part of the Chevron Community, you must have been invited and/or authorized by Chevron.',
    'fr-FR':
      'Pour faire partie de la communauté Chevron, vous devez avoir reçu une invitation et/ou une autorisation de la part de Chevron.',
  },
  ...
  CHEVRON_registrationInternalUserIntro2: {
    'en-US':
      'To get your registration accepted, please provide the appropriate PIDX ID and Chevron password.',
    'fr-FR':
      'Pour poursuivre votre enregistrement, merci d\'entrer le "PIDX ID" et mot de passe Chevron puis valider.',
  },
  ...
  CHEVRON_registrationPidxidVendoridError: {
    'en-US':
      'PIDX ID / ERP Vendor ID are not correct. Please check the values you provided and retry.',
    'fr-FR':
      '"PIDX ID" / "ERP Vendor ID" incorrects. Merci de vérifier les valeurs saisies avant de réessayer.',
  },

  CHEVRON_registrationPidxidPasswordError: {
    'en-US':
      'PIDX ID / Chevron Password are not correct. Please check the values you provided and retry.',
    'fr-FR':
      '"PIDX ID" / Mot de passe incorrects. Merci de vérifier les valeurs saisies avant de réessayer.',
  },
  ...
  multipleTransactionReprocessImpossible: {
    'en-US':
      'One or more of the selected transactions cannot be reprocessed. Please check your selection and retry!',
    'fr-FR':
      'Une ou plusieurs des transactions sélectionnées ne peuvent pas être relancées. Merci de verifier votre sélection et de réessayer !',
  },

  multipleTransactionDeleteImpossible: {
    'en-US':
      'One or more of the selected transactions cannot be deleted. Please check your selection and retry!',
    'fr-FR':
      'Une ou plusieurs des transactions sélectionnées ne peuvent pas être supprimées. Merci de verifier votre sélection et de réessayer !',
  },
  ...
  homeConfigurationNameAlreadyUsed: {
    'en-US':
      'The name `{name}`is already in use by another configuration, choose another one please',
    'fr-FR':
      'Le nom `{name}` est déjà utilisé pour une autre configuration, veuillez en choisir un autre',
  },

  instanceChangeDisabled: {
    'en-US':
      "Instance change isn't possible when you are editing users, permission sets or integrations",
    'fr-FR':
      "Changer d'instance est impossible pendant l'édition d'utilisateurs, de groupes de permissions ou díntégrations.",
  },
  ...
  allColumnsVisible: {
    'en-US':
      'All columns are currently displayed. Hiddens columns can be found here and re-displayed.',
    'fr-FR':
      'Toutes les colonnes sont actuellement visibles. Les colonnes cachées apparaitront ici et pourront être ré-affichées.',
  },
  ...
  unexpectedErrorCheckUrl: {
    'en-US':
      'An unexpected error has occurred. Please retry and check for the URL you requested or contact your system administrator.',
    'fr-FR':
      "Une erreur est survenue. Merci de réessayer en vérifiant l'URL ou contactez votre administrateur système.",
  },
  ...
  confirmUsersDisassociate: {
    'en-US':
      'Are you sure you want to disassociate the selected user(s) from the current instance?',
    'fr-FR':
      "Êtes-vous sûr(e) de vouloir désassocier l'(les) utilisateur(s) sélectionné(s) de l'instance ?",
  },
  ...
  confirmPermsetsDelete: {
    ...
    'fr-FR':
      'Êtes-vous sûr(e) de vouloir supprimer le(s) groupe(s) de permissions sélectionné(s) ?',
  },
  ...
  confirmChangeWithoutSaving: {
    'en-US':
      'There are unsaved changes. Are you sure you want to change the view and loose the changes?',
    'fr-FR':
      'Le contenu a été changé. Êtes-vous sûr(e) de vouloir changer de vue et perdre ces changements ?',
  },
  ...
  frameFormHelperLanguageSelected: {
    'en-US':
      "You can select the language to edit and remove the one you don't want anymore here. You must fill at least the EN language to be able to save your frame",
    'fr-FR':
      "Vous pouvez sélectionner la langue à editer et supprimer celles dont vous n'avez plus besoin ici. Vous devez renseigner au moins la langue EN pour pouvoir sauvegarder une frame",
  },
  ...
  invalidPassword: {
    'en-US':
      'Your password must be 8 to 32 characters long and contains at least 1 upper/lower case letter and 1 number',
    'fr-FR':
      'Le mot de passe doit contenir entre 8 et 32 caractères et au moins 1 majuscule/minuscule et 1 chiffre',
  },
  ...
  userAlreadyExists: {
    'en-US':
      'The user you want to associate to this instance already exists on the system (and maybe already associated to other instances).',
    'fr-FR':
      "L'utilisateur que vous voulez associer sur cette instance existe déjà sur le système. Il est peut être également déjà associé à d'autres instances.",
  },
  ...
  staleLoginSession: {
    'en-US':
      'Your login session is expired. Please wait, it will be automatically refreshed in 5 seconds...',
    'fr-FR':
      'Votre session de connexion a expiré. Merci de patienter, celle-ci sera automatiquement actualisée dans 5 secondes...',
  },
  ...
  membershipEexpired: {
    'en-US':
      'Your company Membership expired on <strong>{expiryDate}</strong>. Please ask your company’s Community administrator<strong>{adminContact}</strong> to renew the Membership.',
    'fr-FR':
      'Votre abonnement a expiré le <strong>{expiryDate}</strong>. Merci de contacter votre administrateur<strong>{adminContact}</strong> pour renouveler le service.',
  },
  ...
  noPermission: {
    'en-US':
      "You don't have access to any instance! Please check your account settings with your administrator.",
    'fr-FR':
      "Vous n'avez aucun droit enregistré. Merci de vérifier le paramétrage de votre compte utilisateur avec votre administrateur.",
  },

  newVersionAvailable: {
    'en-US':
      'The portal needs to be updated to a new version. Please save your current work, the update will be done automatically in 90 seconds...',
    'fr-FR':
      'Le portail doit être mis à jour vers un nouvelle version. Merci de sauvegarder vos travaux en cours, la mise à jour se fera automatiquement dans 90 secondes...',
  },
  ...
  multipleMsgReprocessImpossible: {
    'en-US':
      'One or more of the selected messages cannot be reprocessed. Please check your selection and retry!',
    'fr-FR':
      'Un ou plusieurs des messages sélectionnés ne peuvent pas être relancés. Merci de verifier votre sélection et de réessayer !',
  },

  multipleMsgDeleteImpossible: {
    'en-US':
      'One or more of the selected messages cannot be deleted. Please check your selection and retry!',
    'fr-FR':
      'Un ou plusieurs des messages sélectionnés ne peuvent pas être supprimés. Merci de verifier votre sélection et de réessayer !',
  },
  ...
  organisationsConfirmDeleteLastPosition: {
    'en-US':
      "This is the only organization position held by this user. If you delete it, you won't be able to re-assign this user anywhere in the tree. Are you sure you want to completely remove this user from the organization?",
    'fr-FR':
      "Vous êtes sur le point de supprimer la seule position tenue par cet utilisateur dans l'organisation. Si vous la supprimez, vous ne pourrez plus du tout réassigner cet utilisateur dans l'arbre. Êtes-vous certain de vouloir supprimer complètement cet utilisateur de l'organisation ?",
  },
  ...
  serviceConfirmLeaveWithoutSaving: {
    'en-US':
      'There are unsaved changes. Are you sure you want to leave this page and lose your updates?',
    'fr-FR':
      'Vous avez effectué des modifications sans les enregistrer. Êtes-vous sûr(e) de vouloir quitter cette page et perdre les données non sauvegardées ?',
  },
