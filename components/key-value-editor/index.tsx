...
> {
        ...
        <div className="row" key={idx}>
          ...
          <div className="form-group col-xs-5">
            {keyVal.contentType === 'text/plain' ? (
              ...
              <button
                type="button"
                className="btn btn-info btn-trans"
                onClick={() => this.downloadFile(keyVal.key)}
              >
      ...
      <div>
        ...
        {!readonly ? (
          <div>
            <button
              type="button"
              className="btn btn-trans btn-info right-margin"
              onClick={this.addKeyValue.bind(this)}
              data-toggle="tooltip"
              data-original-title={wordings.addTextProperty}
            >
            ...
            <button
              type="button"
              className="btn btn-trans btn-info"
              onClick={this.addKeyValue.bind(this, true)}
              data-toggle="tooltip"
              data-original-title={wordings.addFileProperty}
            >
              <span className="fas fa-plus right-spaced" />
  ...
  private downloadFile = (key: string) => {
    downloadDataFile(
      this.props.keyValues[key].contentBytes,
      this.props.keyValues[key].contentType,
      key,
    );
  };
