...
class FileWrapper extends React.Component<FileWrapper.Props, FileWrapper.State> {
  ...
  render() {
    ...
    let deleteBtn =
      this.props.uploaded && !this.props.processSuccess ? (
        <div
          data-file-name={this.props.fileName}
          className="file-icon-cell file-delete-btn"
    ...
    let errorMessage =
      this.props.processSuccess === false && this.props.message ? (
      ...
      >
        ...
        <div className="file-details">
          <span
            className="file-name"
            data-toggle="tooltip"
            data-original-title={createdMessageText}
          >
            {this.props.fileName}
          </span>
