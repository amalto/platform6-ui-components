...
module.exports = {
  ...
  require: [path.resolve(__dirname, 'public/sass/main.scss')],
  ...
  getComponentPathLine(componentPath) {
    const packageJsonPath = path.resolve(
      __dirname,
      componentPath.replace('index.tsx', 'package.json'),
    );
      ...
      links: [
        {
          rel: 'stylesheet',
          type: 'text/css',
          href: 'https://portal.amalto.com/assets/vendor/bootstrap-3.3.1/css/bootstrap.min.css',
        },
        {
          rel: 'stylesheet',
          type: 'text/css',
          ...
          integrity:
            'sha384-3AB7yXWz4OeoZcPbieVW64vVXEwADiYyAEhwilzWsLw+9FgqpyjjStpPnpBO8o8S',
          crossorigin: 'anonymous',
        },
        {
          rel: 'stylesheet',
          type: 'text/css',
          href: 'https://portal.amalto.com/fonts/icomoon/style.css',
        },
        {
          rel: 'stylesheet',
          type: 'text/css',
          href: 'https://portal.amalto.com/assets/vendor/animate.min.css',
        },
        {
          rel: 'stylesheet',
          type: 'text/css',
          href: 'https://portal.amalto.com/assets/vendor/pikaday-1.4.0/pikaday.css',
        },
        {
          rel: 'stylesheet',
          type: 'text/css',
          href: 'https://portal.amalto.com/assets/vendor/jstree-3.3.1/themes/default/style.min.css',
        },
        {
          rel: 'stylesheet',
          type: 'text/css',
          href: 'https://dev.portal.amalto.com/assets/generated/styles.css',
        },
      ],
      scripts: [
        {
          type: 'text/javascript',
          src: 'https://portal.amalto.com/assets/vendor/modernizr-custom-3.3.1.min.js',
        },
      ],
    },
    body: {
      scripts: [
        {
          type: 'text/javascript',
          src: 'https://portal.amalto.com/assets/vendor/jquery-2.1.4.min.js',
        },
        {
          type: 'text/javascript',
          src: 'https://portal.amalto.com/assets/vendor/bootstrap-3.3.1/js/bootstrap.min.js',
        },
        {
          type: 'text/javascript',
          src: 'https://portal.amalto.com/assets/vendor/jquery.navgoco-0.2.1.min.js',
        },
        {
          type: 'text/javascript',
          src: 'https://portal.amalto.com/assets/vendor/jquery.fullscreen-1.1.5.min.js',
        },
        {
          type: 'text/javascript',
          src: 'https://portal.amalto.com/assets/vendor/typeahead-0.11.1.min.js',
        },
        {
          type: 'text/javascript',
          src: 'https://portal.amalto.com/assets/vendor/jstree-3.3.1/jstree.min.js',
        },
        {
          type: 'text/javascript',
          src: '//cdn.polyfill.io/v2/polyfill.min.js?features=Intl.~locale.en,Intl.~locale.fr',
        },
      ],
    },
  },
  ...
  ignore: ['**/node_modules/**', '**/test/**', '**/readme/**', '**/public/**'],
  ...
  sections: [
    ...
    },
    {
      name: 'Utils',
      description:
        'Externals resources and commons methods used in several Platform 6 UI components. You should take a look at the resources provided here before any implementation to avoid duplicate code.',
      showCode: false,
      sections: [
        {
          name: 'Font Awesome',
        ...
        },
        {
          name: 'Common classes',
          description:
            'All the custom classes provided with Platform 6 UI components.',
          sections: [
            {
              name: 'Text',
        ...
        },
        {
          name: 'Wordings',
          description:
            'This is all the global text that is displayed on the ui. You can update or create your own wordings.',
